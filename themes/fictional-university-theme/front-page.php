        ...
        <div class="full-width-split__inner">
          ...
          <?php
            ...
            while($homepageEvents->have_posts()) {
              ...
              get_template_part('template-parts/content', 'event'); // get template content-event in template-parts
        ...
        <div class="full-width-split__inner">
          ...
          <div class="event-summary">
            ...
            <div class="event-summary__content">
              ...
              <p><?php /*echo wp_trim_words(get_the_content(), 18);*/ if(has_excerpt()) { echo get_the_excerpt(); } else { echo wp_trim_words(get_the_content(), 18);} ?> <a href="<?php the_permalink(); ?>" class="nu gray">Read more</a></p>
            </div>
          </div>
